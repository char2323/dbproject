...
# --- 关键改动在这里：在 movie 模型中增加了 id 字段 ---
movie_nested_model = ns.model(
    "MovieNested",
    {
        "id": fields.Integer(description="电影ID"),
        "name": fields.String(),
        "cover": fields.String(),
    },
)

order_detail_model = ns.model(
    "OrderDetailModel",
    {
        "id": fields.Integer(),
        ...
        "status": fields.Integer(
            description="0:待支付, 1:已支付/待观影, 2:已完成, 3:已取消"
        ),
