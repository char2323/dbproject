  ...
  <div class="p-4 md:p-8">
    ...
    <div v-if="!isLoading">
      <section>
        ...
        <div v-if="wantToWatchList.length > 0" class="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div v-for="fav in wantToWatchList" :key="fav.movie.id" class="bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <section class="mt-8">
        ...
        <div v-if="haveWatchedList.length > 0" class="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div v-for="fav in haveWatchedList" :key="fav.movie.id" class="bg-white rounded-lg shadow-md overflow-hidden">
            <img :src="fav.movie.cover" :alt="fav.movie.name" class="w-full h-auto object-cover">
            <div class="p-2">
              <h3 class="font-semibold text-sm truncate">{{ fav.movie.name }}</h3>
            </div>
